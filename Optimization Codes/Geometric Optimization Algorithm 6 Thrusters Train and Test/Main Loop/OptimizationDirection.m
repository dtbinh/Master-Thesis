...
cvx_begin
   ...
   minimize(norm(B_dir_Trim1_1*dir_T1-tau_d_1_quasi))
...
fun_diropt=@(x)norm(B_dir_Trim1_1*[x(1);x(2);x(3)]-tau_d_1_quasi);
...
cvx_begin
    variable dir_T2(3)
    dual variables lam2
    minimize(norm(B_dir_Trim1_2*dir_T2-tau_d_1_quasi))
...
fun_diropt=@(x)norm(B_dir_Trim1_2*[x(1);x(2);x(3)]-tau_d_1_quasi);
...
cvx_begin
    variable dir_T3(3)
    dual variables lam3
    minimize(norm(B_dir_Trim1_3*dir_T3-tau_d_1_quasi))
...
fun_diropt=@(x)norm(B_dir_Trim1_3*[x(1);x(2);x(3)]-tau_d_1_quasi);
...
cvx_begin
    variable dir_T4(3)
    dual variables lam4
    minimize(norm(B_dir_Trim1_4*dir_T4-tau_d_1_quasi))
...
fun_diropt=@(x)norm(B_dir_Trim1_4*[x(1);x(2);x(3)]-tau_d_1_quasi);
...
cvx_begin
    variable dir_T5(3)
    dual variables lam5
    minimize(norm(B_dir_Trim1_5*dir_T5-tau_d_1_quasi))
...
fun_diropt=@(x)norm(B_dir_Trim1_5*[x(1);x(2);x(3)]-tau_d_1_quasi);
...
cvx_begin
    variable dir_T6(3)
    dual variables lam6
    minimize(norm(B_dir_Trim1_6*dir_T6-tau_d_1_quasi))
...
fun_diropt=@(x)norm(B_dir_Trim1_6*[x(1);x(2);x(3)]-tau_d_1_quasi);
