...
% In this part we plot only two trajectories 

% the first one or the worse one is used for training

% two trim trajectories, one for 

PathPlanningSpecification_TrainTest;
