...
% % in the current situation 
% 
Cond_sum=cell2mat(Cond_E_1_c);

[mincond,min_conindex]=min(Cond_sum);

min_conindex=index_loop;

r_T1_optimized=r_T1_ck{min_conindex};

r_T2_optimized=r_T2_ck{min_conindex};

r_T3_optimized=r_T3_ck{min_conindex};

r_T4_optimized=r_T4_ck{min_conindex};

r_T5_optimized=r_T5_ck{min_conindex};

r_T6_optimized=r_T6_ck{min_conindex};

% the optimal spin direction   

d_T1_optimized=d_T1_ck{min_conindex};

d_T2_optimized=d_T2_ck{min_conindex};

d_T3_optimized=d_T3_ck{min_conindex};

d_T4_optimized=d_T4_ck{min_conindex};

d_T5_optimized=d_T5_ck{min_conindex};

d_T6_optimized=d_T6_ck{min_conindex};
