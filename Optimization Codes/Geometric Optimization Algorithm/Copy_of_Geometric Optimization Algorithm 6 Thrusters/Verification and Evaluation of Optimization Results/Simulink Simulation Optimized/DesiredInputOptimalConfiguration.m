...
cvx_begin
variable u_d_3(6)
minimize(norm(B_input*u_d_3-tau_d_3))
subject to
...
cvx_begin
variable u_d_4(6)
minimize(norm(B_input*u_d_4-tau_d_4))
subject to
...
cvx_begin
variable u_d_5(6)
minimize(norm(B_input*u_d_5-tau_d_5))
subject to
...
cvx_begin
variable u_d_6(6)
minimize(norm(B_input*u_d_6-tau_d_6))
subject to
...
cvx_begin
variable u_d_7(6)
minimize(norm(B_input*u_d_7-tau_d_7))
subject to
