...
Fin1={C_L,[a_F1,b_F1],u_ind,[x_F1,gama_F1]};

Fin2={C_L,[a_F2,b_F2],u_ind,[x_F2,gama_F2]};

Fin3={C_L,[a_F3,b_F3],u_ind,[x_F3,gama_F3]};

Fin4={C_L,[a_F4,b_F4],u_ind,[x_F4,gama_F4]};
...
% % configuration
% 
% [minval index]=min([cond_b_1_av,cond_b_2_av,cond_b_3_av,cond_b_4_av]);
% 
% 
% b_T_c{index}
...
BestConfiguration=b_T_c{min_index};
min_d=[];
