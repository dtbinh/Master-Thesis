...
%% build the optimal error dynamics, use the intial geometric value


% the optimal configuration from the result 

T_S_1_init={r_T1_init,b_T1_init,d_T1_init};
T_S_2_init={r_T2_init,b_T2_init,d_T2_init}; 
T_S_3_init={r_T3_init,b_T3_init,d_T3_init};
T_S_4_init={r_T4_init,b_T4_init,d_T4_init};
T_S_5_init={r_T5_init,b_T5_init,d_T5_init};
T_S_6_init={r_T6_init,b_T6_init,d_T6_init};

% use the optimal configuration to build the optimal dynamics

B_T=ThrusterConfigurationMatrix(T_S_1_init,T_S_2_init,T_S_3_init,T_S_4_init,T_S_5_init,T_S_6_init);
...
BH=inv(M_RB)*B_input*[T1;T2;T3;T4;T5;T6];
