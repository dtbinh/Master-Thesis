...
% 
% for i=1:index_loop
%    gamma_F1_ck=[gamma_F1_ck;gamma_F1_ck{i}]; 
% end
% 
% 
% 
...
% hold on;
% plot(gamma_F1_ck,'LineWidth',3);
% title('Convergence of the Fin 1 Position');
% xlabel('iterations');
% ylabel('position in body frame {b} (m)');
% legend('x_F1','gamma_F1');
% 
% % thruster 4
% 
% r_T4_x_ck=[];
...
xlabel('iterations');
ylabel('direction in body frame {b}');
legend('d_x','d_y','d_z');
% 
% 
% thruster 2
...
%
figure;
plot(cell2mat(x_F1_ck),'LineWidth',3);
title('Convergence of the Fin 1 Position');
xlabel('iterations');
ylabel('position in body frame {b}(m)');
legend('x_{F1}');
% 
figure;
plot(cell2mat(gamma_F1_ck),'LineWidth',3);
title('Convergence of the Fin 1 Orientation');
xlabel('iterations');
ylabel('orientation in body frame {b}(radian)');
legend('gamma_{F1}');

% Fin2

figure;
plot(cell2mat(x_F2_ck),'LineWidth',3);
title('Convergence of the Fin 2 Position');
xlabel('iterations');
ylabel('position in body frame {b}(m)');
legend('x_{F2}');
% 
figure;
plot(cell2mat(gamma_F2_ck),'LineWidth',3);
title('Convergence of the Fin 2 Orientation');
xlabel('iterations');
ylabel('orientation in body frame {b}(radian)');
legend('gamma_{F2}');
...
% Fin3
figure;
plot(cell2mat(x_F3_ck),'LineWidth',3);
title('Convergence of the Fin 3 Position');
xlabel('iterations');
ylabel('position in body frame {b}(m)');
legend('x_{F3}');
% 
figure;
plot(cell2mat(gamma_F3_ck),'LineWidth',3);
title('Convergence of the Fin 3 Orientation');
xlabel('iterations');
ylabel('orientation in body frame {b}(radian)');
legend('gamma_{F3}');
...
% Fin4
figure;
plot(cell2mat(x_F4_ck),'LineWidth',3);
title('Convergence of the Fin 4 Position');
xlabel('iterations');
ylabel('position in body frame {b}(m)');
legend('x_{F4}');
% 
figure;
plot(cell2mat(gamma_F4_ck),'LineWidth',3);
title('Convergence of the Fin 4 Orientation');
xlabel('iterations');
ylabel('orientation in body frame {b}(radian)');
legend('gamma_{F4}');
