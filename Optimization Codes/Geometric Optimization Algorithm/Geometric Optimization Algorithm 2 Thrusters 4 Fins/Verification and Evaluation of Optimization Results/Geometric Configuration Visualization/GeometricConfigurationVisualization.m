...
V_fin3=[-(x_F3_optimized-b_F3/2) 0.5*d_H*sin(gamma_F3_optimized) -0.5*d_H*cos(gamma_F3_optimized);
        -(x_F3_optimized-b_F3/2) (0.5*d_H+a_F3)*sin(gamma_F3_optimized) -(0.5*d_H+a_F3)*cos(gamma_F3_optimized);
        -(x_F3_optimized+b_F3/2) 0.5*d_H*sin(gamma_F3_optimized) -0.5*d_H*cos(gamma_F3_optimized)
        -(x_F3_optimized+b_F3/2) (0.5*d_H+a_F3)*sin(gamma_F3_optimized) -(0.5*d_H+a_F3)*cos(gamma_F3_optimized) ];
    
   F_fin3_1 = [1 2 3 1];
   F_fin3_2 = [2 3 4 2];
patch('Faces',F_fin3_1,'Vertices',V_fin3) 
patch('Faces',F_fin3_2,'Vertices',V_fin3)

hold on;

% fin4 

V_fin4=[-(x_F4_optimized-b_F4/2) 0.5*d_H*sin(gamma_F4_optimized) -0.5*d_H*cos(gamma_F4_optimized);
        -(x_F4_optimized-b_F4/2) (0.5*d_H+a_F4)*sin(gamma_F4_optimized) -(0.5*d_H+a_F4)*cos(gamma_F4_optimized);
        -(x_F4_optimized+b_F4/2) 0.5*d_H*sin(gamma_F4_optimized) -0.5*d_H*cos(gamma_F4_optimized)
        -(x_F4_optimized+b_F4/2) (0.5*d_H+a_F4)*sin(gamma_F4_optimized) -(0.5*d_H+a_F4)*cos(gamma_F4_optimized) ];
    
   F_fin4_1 = [1 2 3 1];
   F_fin4_2 = [2 3 4 2];
patch('Faces',F_fin4_1,'Vertices',V_fin4) 
patch('Faces',F_fin4_2,'Vertices',V_fin4)
