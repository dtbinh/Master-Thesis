...
% for each trim trajectory  different Fin configuration matrix
...
Fin1={C_L,[a_F1,b_F1],u_ind_5,[veh.x_F1,veh.gamma_F1]};

Fin2={C_L,[a_F2,b_F2],u_ind_5,[veh.x_F2,veh.gamma_F2]};

Fin3={C_L,[a_F3,b_F3],u_ind_5,[veh.x_F3,veh.gamma_F3]};

Fin4={C_L,[a_F4,b_F4],u_ind_5,[veh.x_F4,veh.gamma_F4]};
...
Fin1={C_L,[a_F1,b_F1],u_ind_6,[veh.x_F1,veh.gamma_F1]};

Fin2={C_L,[a_F2,b_F2],u_ind_6,[veh.x_F2,veh.gamma_F2]};

Fin3={C_L,[a_F3,b_F3],u_ind_6,[veh.x_F3,veh.gamma_F3]};

Fin4={C_L,[a_F4,b_F4],u_ind_6,[veh.x_F4,veh.gamma_F4]};
...
Fin1={C_L,[a_F1,b_F1],u_ind_7,[veh.x_F1,veh.gamma_F1]};

Fin2={C_L,[a_F2,b_F2],u_ind_7,[veh.x_F2,veh.gamma_F2]};

Fin3={C_L,[a_F3,b_F3],u_ind_7,[veh.x_F3,veh.gamma_F3]};

Fin4={C_L,[a_F4,b_F4],u_ind_7,[veh.x_F4,veh.gamma_F4]};
