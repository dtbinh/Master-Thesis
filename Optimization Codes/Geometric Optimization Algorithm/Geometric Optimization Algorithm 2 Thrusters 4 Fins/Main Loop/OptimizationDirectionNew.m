...
sum_forces_Trim1_1=B_dir_Trim1_2*veh.d_T2+...
    C_L*a_F1*b_F1*q(u_ind_1)*[0;cos(veh.gamma_F1);sin(veh.gamma_F1);-0.5*(d_H+a_F1);veh.x_F1*sin(veh.gamma_F1);veh.x_F1*cos(veh.gamma_F1)]+...
    C_L*a_F2*b_F2*q(u_ind_1)*[0;cos(veh.gamma_F2);sin(veh.gamma_F2);-0.5*(d_H+a_F2);veh.x_F2*sin(veh.gamma_F2);veh.x_F2*cos(veh.gamma_F2)]+...
    C_L*a_F3*b_F3*q(u_ind_1)*[0;cos(veh.gamma_F3);sin(veh.gamma_F3);-0.5*(d_H+a_F3);veh.x_F3*sin(veh.gamma_F3);veh.x_F3*cos(veh.gamma_F3)]+...
    C_L*a_F4*b_F4*q(u_ind_1)*[0;cos(veh.gamma_F4);sin(veh.gamma_F4);-0.5*(d_H+a_F4);veh.x_F4*sin(veh.gamma_F4);veh.x_F3*cos(veh.gamma_F4)];

sum_forces_Trim2_1=B_dir_Trim2_2*veh.d_T2+...
    C_L*a_F1*b_F1*q(u_ind_2)*[0;cos(veh.gamma_F1);sin(veh.gamma_F1);-0.5*(d_H+a_F1);veh.x_F1*sin(veh.gamma_F1);veh.x_F1*cos(veh.gamma_F1)]+...
    C_L*a_F2*b_F2*q(u_ind_2)*[0;cos(veh.gamma_F2);sin(veh.gamma_F2);-0.5*(d_H+a_F2);veh.x_F2*sin(veh.gamma_F2);veh.x_F2*cos(veh.gamma_F2)]+...
    C_L*a_F3*b_F3*q(u_ind_2)*[0;cos(veh.gamma_F3);sin(veh.gamma_F3);-0.5*(d_H+a_F3);veh.x_F3*sin(veh.gamma_F3);veh.x_F3*cos(veh.gamma_F3)]+...
    C_L*a_F4*b_F4*q(u_ind_2)*[0;cos(veh.gamma_F4);sin(veh.gamma_F4);-0.5*(d_H+a_F4);veh.x_F4*sin(veh.gamma_F4);veh.x_F3*cos(veh.gamma_F4)];
sum_forces_Trim3_1=B_dir_Trim3_2*veh.d_T2+...
    C_L*a_F1*b_F1*q(u_ind_3)*[0;cos(veh.gamma_F1);sin(veh.gamma_F1);-0.5*(d_H+a_F1);veh.x_F1*sin(veh.gamma_F1);veh.x_F1*cos(veh.gamma_F1)]+...
    C_L*a_F2*b_F2*q(u_ind_3)*[0;cos(veh.gamma_F2);sin(veh.gamma_F2);-0.5*(d_H+a_F2);veh.x_F2*sin(veh.gamma_F2);veh.x_F2*cos(veh.gamma_F2)]+...
    C_L*a_F3*b_F3*q(u_ind_3)*[0;cos(veh.gamma_F3);sin(veh.gamma_F3);-0.5*(d_H+a_F3);veh.x_F3*sin(veh.gamma_F3);veh.x_F3*cos(veh.gamma_F3)]+...
    C_L*a_F4*b_F4*q(u_ind_3)*[0;cos(veh.gamma_F4);sin(veh.gamma_F4);-0.5*(d_H+a_F4);veh.x_F4*sin(veh.gamma_F4);veh.x_F3*cos(veh.gamma_F4)];
sum_forces_Trim4_1=B_dir_Trim4_2*veh.d_T2+...
    C_L*a_F1*b_F1*q(u_ind_4)*[0;cos(veh.gamma_F1);sin(veh.gamma_F1);-0.5*(d_H+a_F1);veh.x_F1*sin(veh.gamma_F1);veh.x_F1*cos(veh.gamma_F1)]+...
    C_L*a_F2*b_F2*q(u_ind_4)*[0;cos(veh.gamma_F2);sin(veh.gamma_F2);-0.5*(d_H+a_F2);veh.x_F2*sin(veh.gamma_F2);veh.x_F2*cos(veh.gamma_F2)]+...
    C_L*a_F3*b_F3*q(u_ind_4)*[0;cos(veh.gamma_F3);sin(veh.gamma_F3);-0.5*(d_H+a_F3);veh.x_F3*sin(veh.gamma_F3);veh.x_F3*cos(veh.gamma_F3)]+...
    C_L*a_F4*b_F4*q(u_ind_4)*[0;cos(veh.gamma_F4);sin(veh.gamma_F4);-0.5*(d_H+a_F4);veh.x_F4*sin(veh.gamma_F4);veh.x_F3*cos(veh.gamma_F4)];
sum_forces_Trim5_1=B_dir_Trim5_2*veh.d_T2+...
    C_L*a_F1*b_F1*q(u_ind_5)*[0;cos(veh.gamma_F1);sin(veh.gamma_F1);-0.5*(d_H+a_F1);veh.x_F1*sin(veh.gamma_F1);veh.x_F1*cos(veh.gamma_F1)]+...
    C_L*a_F2*b_F2*q(u_ind_5)*[0;cos(veh.gamma_F2);sin(veh.gamma_F2);-0.5*(d_H+a_F2);veh.x_F2*sin(veh.gamma_F2);veh.x_F2*cos(veh.gamma_F2)]+...
    C_L*a_F3*b_F3*q(u_ind_5)*[0;cos(veh.gamma_F3);sin(veh.gamma_F3);-0.5*(d_H+a_F3);veh.x_F3*sin(veh.gamma_F3);veh.x_F3*cos(veh.gamma_F3)]+...
    C_L*a_F4*b_F4*q(u_ind_5)*[0;cos(veh.gamma_F4);sin(veh.gamma_F4);-0.5*(d_H+a_F4);veh.x_F4*sin(veh.gamma_F4);veh.x_F3*cos(veh.gamma_F4)];
sum_forces_Trim6_1=B_dir_Trim6_2*veh.d_T2+...
    C_L*a_F1*b_F1*q(u_ind_6)*[0;cos(veh.gamma_F1);sin(veh.gamma_F1);-0.5*(d_H+a_F1);veh.x_F1*sin(veh.gamma_F1);veh.x_F1*cos(veh.gamma_F1)]+...
    C_L*a_F2*b_F2*q(u_ind_6)*[0;cos(veh.gamma_F2);sin(veh.gamma_F2);-0.5*(d_H+a_F2);veh.x_F2*sin(veh.gamma_F2);veh.x_F2*cos(veh.gamma_F2)]+...
    C_L*a_F3*b_F3*q(u_ind_6)*[0;cos(veh.gamma_F3);sin(veh.gamma_F3);-0.5*(d_H+a_F3);veh.x_F3*sin(veh.gamma_F3);veh.x_F3*cos(veh.gamma_F3)]+...
    C_L*a_F4*b_F4*q(u_ind_6)*[0;cos(veh.gamma_F4);sin(veh.gamma_F4);-0.5*(d_H+a_F4);veh.x_F4*sin(veh.gamma_F4);veh.x_F3*cos(veh.gamma_F4)];
sum_forces_Trim7_1=B_dir_Trim7_2*veh.d_T2+...
    C_L*a_F1*b_F1*q(u_ind_7)*[0;cos(veh.gamma_F1);sin(veh.gamma_F1);-0.5*(d_H+a_F1);veh.x_F1*sin(veh.gamma_F1);veh.x_F1*cos(veh.gamma_F1)]+...
    C_L*a_F2*b_F2*q(u_ind_7)*[0;cos(veh.gamma_F2);sin(veh.gamma_F2);-0.5*(d_H+a_F2);veh.x_F2*sin(veh.gamma_F2);veh.x_F2*cos(veh.gamma_F2)]+...
    C_L*a_F3*b_F3*q(u_ind_7)*[0;cos(veh.gamma_F3);sin(veh.gamma_F3);-0.5*(d_H+a_F3);veh.x_F3*sin(veh.gamma_F3);veh.x_F3*cos(veh.gamma_F3)]+...
    C_L*a_F4*b_F4*q(u_ind_7)*[0;cos(veh.gamma_F4);sin(veh.gamma_F4);-0.5*(d_H+a_F4);veh.x_F4*sin(veh.gamma_F4);veh.x_F3*cos(veh.gamma_F4)];
