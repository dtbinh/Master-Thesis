...
B_pos_fin_1_1=u_d_1(3)*MomentCalculationFin(C_L,a_F1,b_F1,u_ind_1,veh.gamma_F1,d_H);
B_pos_fin_1_2=u_d_1(4)*MomentCalculationFin(C_L,a_F2,b_F2,u_ind_1,veh.gamma_F2,d_H);
B_pos_fin_1_3=u_d_1(5)*MomentCalculationFin(C_L,a_F2,b_F2,u_ind_1,veh.gamma_F3,d_H);
B_pos_fin_1_4=u_d_1(6)*MomentCalculationFin(C_L,a_F2,b_F2,u_ind_1,veh.gamma_F4,d_H);
...
B_pos_fin_2_1=u_d_2(3)*MomentCalculationFin(C_L,a_F1,b_F1,u_ind_2,veh.gamma_F1,d_H);
B_pos_fin_2_2=u_d_2(4)*MomentCalculationFin(C_L,a_F2,b_F2,u_ind_2,veh.gamma_F2,d_H);
B_pos_fin_2_3=u_d_2(5)*MomentCalculationFin(C_L,a_F3,b_F3,u_ind_2,veh.gamma_F3,d_H);
B_pos_fin_2_4=u_d_2(6)*MomentCalculationFin(C_L,a_F4,b_F4,u_ind_2,veh.gamma_F4,d_H);
...
B_pos_fin_3_1=u_d_3(3)*MomentCalculationFin(C_L,a_F1,b_F1,u_ind_3,veh.gamma_F1,d_H);
B_pos_fin_3_2=u_d_3(4)*MomentCalculationFin(C_L,a_F2,b_F2,u_ind_3,veh.gamma_F2,d_H);
B_pos_fin_3_3=u_d_3(5)*MomentCalculationFin(C_L,a_F3,b_F2,u_ind_3,veh.gamma_F3,d_H);
B_pos_fin_3_4=u_d_3(6)*MomentCalculationFin(C_L,a_F4,b_F2,u_ind_3,veh.gamma_F4,d_H);
...
B_pos_fin_4_1=u_d_4(3)*MomentCalculationFin(C_L,a_F1,b_F1,u_ind_4,veh.gamma_F1,d_H);
B_pos_fin_4_2=u_d_4(4)*MomentCalculationFin(C_L,a_F2,b_F2,u_ind_4,veh.gamma_F2,d_H);
B_pos_fin_4_3=u_d_4(5)*MomentCalculationFin(C_L,a_F3,b_F3,u_ind_4,veh.gamma_F3,d_H);
B_pos_fin_4_4=u_d_4(6)*MomentCalculationFin(C_L,a_F4,b_F4,u_ind_4,veh.gamma_F4,d_H);
...
B_pos_fin_5_1=u_d_5(3)*MomentCalculationFin(C_L,a_F1,b_F1,u_ind_5,veh.gamma_F1,d_H);
B_pos_fin_5_2=u_d_5(4)*MomentCalculationFin(C_L,a_F2,b_F2,u_ind_5,veh.gamma_F2,d_H);
B_pos_fin_5_3=u_d_5(5)*MomentCalculationFin(C_L,a_F3,b_F3,u_ind_5,veh.gamma_F3,d_H);
B_pos_fin_5_4=u_d_5(6)*MomentCalculationFin(C_L,a_F4,b_F4,u_ind_5,veh.gamma_F4,d_H);
...
B_pos_fin_6_1=u_d_6(3)*MomentCalculationFin(C_L,a_F1,b_F1,u_ind_6,veh.gamma_F1,d_H);
B_pos_fin_6_2=u_d_6(4)*MomentCalculationFin(C_L,a_F2,b_F2,u_ind_6,veh.gamma_F2,d_H);
B_pos_fin_6_3=u_d_6(5)*MomentCalculationFin(C_L,a_F3,b_F3,u_ind_6,veh.gamma_F3,d_H);
B_pos_fin_6_4=u_d_6(6)*MomentCalculationFin(C_L,a_F4,b_F4,u_ind_6,veh.gamma_F4,d_H);
...
B_pos_fin_7_1=u_d_7(3)*MomentCalculationFin(C_L,a_F1,b_F1,u_ind_7,veh.gamma_F1,d_H);
B_pos_fin_7_2=u_d_7(4)*MomentCalculationFin(C_L,a_F2,b_F2,u_ind_7,veh.gamma_F2,d_H);
B_pos_fin_7_3=u_d_7(5)*MomentCalculationFin(C_L,a_F3,b_F3,u_ind_7,veh.gamma_F3,d_H);
B_pos_fin_7_4=u_d_7(6)*MomentCalculationFin(C_L,a_F4,b_F4,u_ind_7,veh.gamma_F4,d_H);
...
fun=@(x_pos)norm(B_pos*[x_pos(1);rho_T1*cos(x_pos(2));rho_T1*sin(x_pos(2));x_pos(3);rho_T2*cos(x_pos(4));rho_T2*sin(x_pos(4));1;x_pos(5);x_pos(5);1;x_pos(6);x_pos(6);1;x_pos(7);x_pos(7);1;x_pos(8);x_pos(8)]-M_d);

% for the first iteration, the initial value should be generated randomly

% for the following iteration we should use the result from the last
% iteration, the 

 x0_pos=[x_Cyl_T1,phi_T1,x_Cyl_T2,phi_T2,x_F1,x_F2,x_F3,x_F4];
...
lb_pos=[-l_H/2,-pi,-l_H/2,-pi,-(l_H-b_F1)/2,-(l_H-b_F2)/2,-(l_H-b_F3)/2,-(l_H-b_F4)/2];
ub_pos=[l_H/2,pi,l_H/2,pi,(l_H-b_F1)/2,(l_H-b_F2)/2,(l_H-b_F3)/2,(l_H-b_F4)/2];
...
% in this optimization phase we we only optimize the 
